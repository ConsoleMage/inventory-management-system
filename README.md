...
I used a while statement to start the program, ensuring it exits only upon user input. Any input triggers a method call. A foreach statement iterates through the inventory and prints product information for each item.
